      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          <p>
            ...
            <br />
            On my side, I’ve never seen this as a problem. In fact, I’ve always
            instinctively understood what needs to be done just by observing the
            venue, the crowd, and listening to the stakeholders’ desires. <br />
            <br />
            As a designer, I’ve experienced this too. Listening and observing a
            problematic situation to craft the best solution for it. I’ve
