...
export default function Selectedwork2() {
  return (
          ...
          <div className={styles.workCardLeft}>
            <div className={styles.workCardMozilla}>
              ...
              <div className={styles.yearLeft}>
                <span>2025</span>
                <div className={styles.yearStopLeft}></div>
              </div>
            </div>
          </div>
          <div className={styles.centerPage}></div>
          <div className={styles.wordCardRight}>
            <div className={styles.workCard}>
              <div className={styles.year}>
                <div className={styles.yearStop}></div>
                <span>2024</span>
              </div>
              <div className={styles.workCardContent}>
                <div className={styles.workCardTop}>
                ...
                <div className={styles.downWorkCard}>
                  <div className={styles.wordCardImage}>
                    <Image
                      src="/northlamb.png"
                      alt="Description de l'image"
